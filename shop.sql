...
CREATE TABLE `items` (
  ...
  `Status_Visible` smallint(6) NOT NULL DEFAULT 1,
  ...
  `Fixed_shipping_price_Ndzuwani` tinyint(1) NOT NULL,
  `Fixed_shipping_price_Mwali` tinyint(1) NOT NULL,
  `Fixed_shipping_price_France` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `orderdetails` (
  ...
  `reason_for_returned_orders` text DEFAULT NULL,
...
CREATE TABLE `sim_card_slot` (
  `SIM_Card_Slot_ID` int(11) NOT NULL,
...
CREATE TABLE `status_visible_prod` (
  `sta_us_id` smallint(11) NOT NULL,
...
--
ALTER TABLE `adress`
  MODIFY `AdressID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT for table `brand`
--
ALTER TABLE `brand`
  MODIFY `BrandID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=495;

--
-- AUTO_INCREMENT for table `camera_resolution`
--
ALTER TABLE `camera_resolution`
  MODIFY `Resolution_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `gpu`
  MODIFY `GPU_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000000;

--
-- AUTO_INCREMENT for table `incart`
--
ALTER TABLE `incart`
  MODIFY `Incart_Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `names`
  MODIFY `NameID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `network`
--
ALTER TABLE `network`
  MODIFY `connective_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `network_for_product`
--
ALTER TABLE `network_for_product`
  MODIFY `ne_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=253;
...
--
ALTER TABLE `orderdetails`
  MODIFY `orders_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT for table `payemts_allow_detais`
--
ALTER TABLE `payemts_allow_detais`
  MODIFY `__id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=707;
...
--
ALTER TABLE `paypals`
  MODIFY `PaypalID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `ram`
  MODIFY `RamID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `sim_card_slot`
  MODIFY `SIM_Card_Slot_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ssd`
--
ALTER TABLE `ssd`
  MODIFY `SSD_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `status_visible_prod`
--
ALTER TABLE `status_visible_prod`
  MODIFY `sta_us_id` smallint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `time_searched_word`
  MODIFY `time_searched_word_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT for table `used_status_product`
--
ALTER TABLE `used_status_product`
  MODIFY `Staus_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `items`
  ...
  ADD CONSTRAINT `Status_Visible_Prod___` FOREIGN KEY (`Status_Visible`) REFERENCES `status_visible_prod` (`sta_us_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
...
--
ALTER TABLE `payemts_allow_detais`
  ADD CONSTRAINT `paym_id` FOREIGN KEY (`Payment_id`) REFERENCES `payment_method` (`payment_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `place_shi` FOREIGN KEY (`Place_Ship`) REFERENCES `ship_place` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
